...
import com.mall.manager.user.constant.CookieContant;
import com.mall.manager.user.constant.RedisContant;
import com.mall.manager.user.entity.UserInfo;
import com.mall.manager.user.enums.ResultEnum;
import com.mall.manager.user.enums.RoleEnum;
import com.mall.manager.user.service.UserInfoService;
import com.mall.manager.user.util.CookieUtil;
import com.mall.manager.user.util.ResultVOUtil;
